...
Celem projektu jest implementacja i porównanie działania popularnych algorytmów skrótu:
- **MD5**
- **SHA-1**
- **SHA-256 (SHA-2)**

Każdy z algorytmów został zaimplementowany w trzech językach programowania:
- **C++**
- **Python**
- **C#**

#  Instrukcja uruchomienia GUI
